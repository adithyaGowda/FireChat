        ...
        <div className="message">
          ...
          <div className="texts">
            <p>
              ...
              quidem necessitatibus sed, obcaecati error commodi! Accusamus
              reiciendis fugit placeat ratione sequi, reprehenderit esse eius
              perferendis nobis itaque totam quam beatae.
            </p>
            <span>1 min ago</span>
          </div>
        </div>
